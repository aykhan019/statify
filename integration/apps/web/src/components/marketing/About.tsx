...
export function About() {
  return (
    <section id="about" className="scroll-mt-20 bg-surface-page py-32">
      <Container size="wide" gutter="page" className="grid items-center gap-20 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-fg-muted">
            ...
            creation, admin operations, and SQL analytics into one demoable product — built as a
            graduation project at StepIT Academy.
          </p>
          <Link
