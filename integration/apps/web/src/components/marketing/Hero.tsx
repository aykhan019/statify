      ...
      >
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3.5">
            <Link
              href="/signup"
              className="inline-flex h-12 items-center gap-2 rounded-(--radius-md) bg-white px-6 text-sm font-semibold text-fg-strong motion-interactive hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring-focus-paper"
              style={{
                boxShadow:
